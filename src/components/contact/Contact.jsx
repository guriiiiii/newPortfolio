...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_hpisafs', 'template_8es39ww', form.current, 'LOIyWjf3P0gYm6_6O')
        e.target.reset();
    };
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">gurtegs11@gmail.com</span>
                        
                        <a href="mailto:gurtegs11@gmail.com" className="contact__button">
                            Write Me{" "} 
